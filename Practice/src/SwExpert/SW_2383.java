...
//    static int[][]      arr;
//    static SwExpert.Stair[]      stair;               // 1번, 2번 계단
//    static int[]        dx = { 1, 0, -1, 0 };
//    static int[]        dy = { 0, 1, 0, -1 };
//
//    public static void init() {
//        arr = new int[N][N];
//        stair = new SwExpert.Stair[2];
...
//    }
//
//    static class SwExpert.Stair {
//        int i;
//        int j;
//        int depth;
//
//        SwExpert.Stair(int i, int j, int depth) {
//            this.i = i;
//            this.j = j;
//            this.depth = depth;
//        }
...
//                    } else if (arr[i][j] != 0) {
//                        if (stair[0] == null) {
//                            stair[0] = new SwExpert.Stair(i, j, arr[i][j]);
//                        } else {
//                            stair[1] = new SwExpert.Stair(i, j, arr[i][j]);
//                        }
//                    }
//                }
//            }
